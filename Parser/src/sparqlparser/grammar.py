    ...
    def __str__(self):
        ...
        for t in self.items:
            if isinstance(t[1], str):
                ...
                assert isinstance(t[1], ParseInfo), type(t)
...
#                 all([i[1].__isLabelConsistent() if isinstance(i[1], ParseInfo) else i[0] == None for i in self.getItems()])
    ...
    def copy(self):
        ...
        result = globals()[self.__class__.__name__](self.getLabel(), self.__copyItems())
...
#             print('DEBUG: e.name =', e.getLabel())
    ...
    def getLabels(self):
        ...
        return(filter(None, [i[1].getLabel() for i in self.getItems() if isinstance(i[1], ParseInfo)]))
        ...
        def dumpItems(items, indent, step):
            ...
            for i in items:
                if isinstance(i[1], str):
                    result += dumpString(i[1], indent+step, step)
#                 elif isinstance(v, list):
#                     dumpItems(v, indent+step, step)
                else:
                    assert isinstance(i[1], ParseInfo) 
                    result += i[1].dump(indent+step, step)
            return result       
...
#     '''Similar to a delimited list of instances from a ParseList subclass, but includes the separator in its ParseResults.
#     Creates a simple list of matched tokens separated by the separator.'''
#      
#     return pattern + ZeroOrMore(sep + pattern)
...
class GROUP_CONCAT_kw(ParseInfo): pass
...
class SEPARATOR_kw(ParseInfo): pass
...
class NOT_EXISTS_kw(ParseInfo): pass
...
class REPLACE_kw(ParseInfo): pass
...
class LANGMATCHES_kw(ParseInfo): pass
...
class DATATYPE_kw(ParseInfo): pass
...
class ENCODE_FOR_URI_kw(ParseInfo): pass
...
class CONTAINS_kw(ParseInfo): pass
...
class STRSTARTS_kw(ParseInfo): pass
...
class STRENDS_kw(ParseInfo): pass
...
class STRBEFORE_kw(ParseInfo): pass
...
class STRAFTER_kw(ParseInfo): pass
...
class SECONDS_kw(ParseInfo): pass
...
class sameTerm_kw(ParseInfo): pass
...
class isLITERAL_kw(ParseInfo): pass
...
class isNUMERIC_kw(ParseInfo): pass
...
class NOT_IN_kw(ParseInfo): pass
...
class OPTIONAL_kw(ParseInfo): pass
...
class DEFAULT_kw(ParseInfo): pass
...
class DELETE_WHERE_kw(ParseInfo): pass
...
class DELETE_DATA_kw(ParseInfo): pass
...
class INSERT_DATA_kw(ParseInfo): pass
...
class ORDER_BY_kw(ParseInfo): pass
...
class HAVING_kw(ParseInfo): pass
...
class GROUP_BY_kw(ParseInfo): pass
...
class CONSTRUCT_kw(ParseInfo): pass
...
class SELECT_kw(ParseInfo): pass
...
class REDUCED_kw(ParseInfo): pass
